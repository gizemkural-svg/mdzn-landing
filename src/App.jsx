...
// --- MODAL COMPONENT (Moved up to prevent definition errors) ---
          ...
          <>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto">
              ...
              <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full bg-neutral-900 hover:bg-neutral-800 text-white py-2.5 sm:py-3 rounded-lg font-bold transition-colors mt-2 text-sm font-inter">
                  Gönder
                </button>
              </form>
            </div>
         ...
         <div className="max-w-7xl mx-auto">
            <div className="relative bg-neutral-50 border border-neutral-200 rounded-[2.5rem] overflow-hidden">
               ...
               <div className="relative z-10 flex justify-center mt-4 sm:mt-8">
                  ...
                  {/* Floating Widgets (Desktop Only) - positioned relative to container */}
